...
export default function HausPage() {
  return <main className="glishoru gSubpage"><GlishoruHeader />
    ...
    <section className="gReviews gHouseReviews" aria-label="Gästebewertungen"><div className="gRating"><strong>4.8</strong><span>★★★★★</span><p>Mehr als 100 Google-Bewertungen</p><a href="https://www.google.com/search?q=Restaurant+Glishoru+Bewertungen" target="_blank" rel="noreferrer">Bewertungen ansehen ↗</a></div><blockquote>„Eine kleine, schöne Karte mit frischen lokalen Gerichten und innovativen, internationalen Ideen. Sehr persönlicher, freundlicher Service.“<cite>— Gast auf Tripadvisor</cite></blockquote><blockquote>„Top-Adresse, sensationelle Küche und ausgezeichnete Bedienung. Hier wird ein hervorragender Job gemacht.“<cite>— Gast auf Tripadvisor</cite></blockquote></section>
