...
export default function HausPage() {
  return <main className="glishoru gSubpage"><GlishoruHeader />
    ...
    <section className="gValues"><article><span>01</span><h3>Regional</h3><p>Wir arbeiten bevorzugt mit Produkten aus der Region und folgen den Jahreszeiten.</p></article><article><span>02</span><h3>Persönlich</h3><p>Aufmerksamer Service, ehrliche Empfehlungen und Zeit für unsere Gäste.</p></article><article><span>03</span><h3>Mit Charakter</h3><p>Tradition darf sich weiterentwickeln – auf dem Teller wie im Gastraum.</p></article></section>
